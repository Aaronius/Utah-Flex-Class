...
internal class _TwitterResultsEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("since_id", "max_id", "results", "page", "query", "refresh_url", "results_per_page", "next_page", "completed_in");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("since_id", "max_id", "results", "page", "query", "refresh_url", "results_per_page", "next_page", "completed_in");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("since_id", "max_id", "results", "page", "query", "refresh_url", "results_per_page", "next_page", "completed_in");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("since_id", "max_id", "results", "page", "query", "refresh_url", "results_per_page", "next_page", "completed_in");

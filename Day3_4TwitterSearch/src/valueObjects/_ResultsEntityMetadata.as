...
internal class _ResultsEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "to_user_id", "from_user_id", "text", "geo", "source", "iso_language_code", "from_user", "created_at", "profile_image_url", "metadata");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "to_user_id", "from_user_id", "text", "geo", "source", "iso_language_code", "from_user", "created_at", "profile_image_url", "metadata");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "to_user_id", "from_user_id", "text", "geo", "source", "iso_language_code", "from_user", "created_at", "profile_image_url", "metadata");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "to_user_id", "from_user_id", "text", "geo", "source", "iso_language_code", "from_user", "created_at", "profile_image_url", "metadata");
